...
class Response
{
    ...
    {
        // Descarta cualquier salida previa (warnings, BOM, espacios) para garantizar JSON limpio.
        ...
        if ($encoded === false) {
            error_log('Vixy Response::json falló al codificar: ' . json_last_error_msg());
            http_response_code(500);
            header('Content-Type: application/json; charset=utf-8');
            echo json_encode(['success' => false, 'error' => 'Error al generar la respuesta JSON. Revisa el error_log de PHP.']);
            exit;
        }
